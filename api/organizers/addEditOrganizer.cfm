		...
		<div class="container-fluid ml-3 mr-3 mt-3 mb-3">
			<div class="row flex-xl-nowrap">
				...
				<main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">  	 	   				    
					...
					<h1>Add Organizer</h1><br />

					<h4>Updated</h4>
					<p>January 23, 2023</p>
					
			    	<h4>Method Name</h4>
					<p><code>addEditOrganizer()</code></p>
		
					<h4>WSDL</h4>
					<p><code>http[s]://[SERVERNAME]/vfdb/cfc/VFDBOrgService.cfc?wsdl</code></p>
					
					<h4>URL</h4>
					<p><code>http[s]://[SERVERNAME]/vfdb/cfc/VFDBOrgService.cfc?method=addEditOrganizer&orginfo=</code></p>					
		
					<h4>Description</h4>
					<p>The <code>addEditOrganizer()</code> method adds an organizer to the database if none exists, or edits it if there was one already with the same name.</p>
					
					<h4>Input</h4>
					<p>Variable name: <code>orginfo</code></p>
					<pre><code>
                {
                    "org_name":[VARCHAR(50)],
					...
					<pre><code>
		{
			"id":[INTEGER]			
					...
					<cfif IsDefined("Form.goAhead")>
					  ...
					  <cfset orginfo = serializeJSON(predata) />
					  <cfset outputtext = createObject('component','vfdbcfc.VFDBOrgService').addEditOrganizer(orginfo) />
					  <div>
					  	<cfoutput >
