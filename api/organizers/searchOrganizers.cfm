		...
		<div class="container-fluid ml-3 mr-3 mt-3 mb-3">
			<div class="row flex-xl-nowrap">
				...
				<main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">  	 	   				    
					...
					<h1>Search Organizers</h1><br />

					<h4>Updated</h4>
					<p>January 22, 2023</p>
					
			    	<h4>Method Name</h4>
					<p><code>searchOrganizers()</code></p>
		
					<h4>WSDL</h4>
					<p><code>http[s]://[SERVERNAME]/vfdb/cfc/VFDBOrgService.cfc?wsdl</code></p>
					
					<h4>URL</h4>
					<p><code>http[s]://[SERVERNAME]/vfdb/cfc/VFDBOrgService.cfc?method=searchOrganizers&snippet=</code></p>					
		
					<h4>Description</h4>
					<p>The <code>searchOrganizers()</code> method looks for all the organizers.</p>
					...
					<pre><code>
				{
				  "snippet":[string]
					...
					<ul>
						<li>snippet: the text we want to search in the organizer's name or IG handle. If zero, we search for all organizers.</li>
					</ul>
					...
					<pre><code>
		{
			...
			"errormessage": [STRING]			
					...
					<cfif IsDefined("Form.goAhead")>
					  ...
					  <cfset outputtext = createObject('component','vfdbcfc.VFDBOrgService').searchOrganizers(snippet) />
					  <div>
					  	<cfoutput >
